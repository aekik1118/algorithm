...
class StudentScores:
    ...
    # 학생의 성적표 출력 함수
    def printGradeCard(self):
        print()
        print("============================================================")
        print(self.name + "의 성적표 입니다")
        print("출신학교: ", self.highschool)
        print("성별: ", self.gender)
        print("국어 등급:", ratingByScore(self.korean))
        print("국어 백분율:", getPercentage("국어", self.korean))
        print("영어 등급:", ratingByScore(self.english))
        print("영어 백분율:", getPercentage("영어", self.english))
        print("수학 등급:", ratingByScore(self.math))
        print("수학 백분율:", getPercentage("수학", self.math))
        print(self.subjectList[0], "등급:", subjectRatingByScore(self.subject1))
        print(self.subjectList[0], "백분율:", getPercentage(self.subjectList[0], self.subject1))
        print(self.subjectList[1], "등급:", subjectRatingByScore(self.subject2))
        print(self.subjectList[1], "백분율:", getPercentage(self.subjectList[1], self.subject2))
        print("============================================================")
        print()
